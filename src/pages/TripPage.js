...
const Trip = ({ isAuth,isadmin }) => {
    ...
    <div className="section">
        ...
        {loadingdone2 && loadingdone3 && <div className='w-[80%] mx-auto mt-4 h-[85vh] overflow-hidden sm:overflow-y-auto sm:max-w-full p-box-shadow-2 rounded-[20px] mb-4'>
            {console.log("this should not work", infoObject)}
            {console.log("hasmore", hasMore)}
            {!isbooking && <div className=" w-full rounded-20px grid grid-cols-2 sm:grid-cols-1 sm:grid-rows-[500px,500px] ">
