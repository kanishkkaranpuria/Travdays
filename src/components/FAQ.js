    ...
    return (
      <>
        ...
        {answerstatus[faq.id]
          ...
          ? <div className='mb-4 ml-[-2px] hover:opacity-50' >
        ...
        {answerstatus[faq.id] && <div className="text-md sm:text-[0.8rem] inline-block mb-4" >{answer[faq.id]}
  ...
  return (<>
    ...
    {!realLoading &&
      <div className="section">
        <div className=' w-[800px] sm:w-[100%] mx-auto mt-[5%] p-box-shadow-2 rounded-lg h-[80vh] overflow-y-auto overflow-x-hidden p-6 sm:pt-[60px] bg-[#f5f5f7] '>
          <span className='text-6xl sm:text-md font-bold sm:p-2 inline-block faq-link mb-8'>FAQ</span>
          <div>
            {faqs && faqs.map((faq, index) => {
              if (faqs.length === index + 1) {
                return (
                  <div ref={lastDataElementRef} id={faq.id} className="py-2">
