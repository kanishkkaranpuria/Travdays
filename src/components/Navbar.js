                ...
                {isauthenticated ? <>
                    <span className='packages btn flex items-center h-full text-lg relative'>
                        ...
                        <span className='package-list absolute left-0 bottom-[-156px] flex flex-col w-max z-[4] invisible pointer-events-none'>
                            <Link className='bg-[#00000088] px-6 pb-6 rounded-b-[10px] p-box-shadow' to='/trips/solo'><h4>Change Name</h4></Link>
                            <Link className='bg-[#00000088] px-6 pb-6 rounded-b-[10px] p-box-shadow' to='/trips/pet friendly'><h4>Bookings</h4></Link>
                            <Link className='bg-[#00000088] px-6 pb-6 rounded-b-[10px] p-box-shadow' to='/trips/workation'><h4>Blogs</h4></Link>
                        </span>
                    </span>
